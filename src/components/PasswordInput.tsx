 ...
 * mientras se escribe.
 */
export function PasswordInput({ value, onChange, required, minLength, autoComplete, placeholder }: PasswordInputProps) {
  ...
  return (
    <div className="relative">
      <input
        ...
        value={value}
        onChange={onChange}
        className="w-full rounded-lg border border-slate-300 px-3 py-2 pr-10 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
      />
      <button
        type="button"
